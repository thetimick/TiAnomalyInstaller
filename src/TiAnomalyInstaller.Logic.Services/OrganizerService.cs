...
{
    public Task ConfigureAsync(string profile, CancellationToken token);
}

public sealed partial class OrganizerService: IOrganizerService
{
    public async Task ConfigureAsync(string profile, CancellationToken token)
    {
        var fileName = Constants.Files.MO2.ConfigFileName;
...
public partial class OrganizerService
{
